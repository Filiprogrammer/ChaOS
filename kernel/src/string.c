...
/**
 * @brief Computes the length of a string (not including the null terminator).
 * 
...
/**
 * @brief Copies up to n characters from the string pointed to, by src to dest. In a case where the length of src is less than n, the remainder of dest will be padded with null bytes.
 * 
 * @param dest pointer to destination where the content is to be copied to.
 * @param src the string to be copied.
...
/**
 * @brief Converts all letters of a string to lower case.
 * 
...
/**
 * @brief Converts all letters of a string to upper case.
 * 
 * @param str string to be converted.
 * @return char* pointer to the converted string str.
 */
...
/**
 * @brief Removes leading and trailing white-space characters.
 * 
