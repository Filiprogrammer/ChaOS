...
extern void memshow(const void* start, size_t count);
...
extern uint8_t BSDChecksum(const char* str);
...
extern void nop();
extern void hlt();
extern void uitoa(uint32_t value, char* str, int32_t base);
extern void itoa(int32_t value, char* str, int32_t base);
extern void i2hex(uint32_t val, char* dest, int32_t len);
extern size_t ftoa(double value, char* str, int32_t precision);
